    ...
    return (
        <div className="signup">
            ...
            <Form onSubmit = {handleSubmit}>
                ...
                <Row className="justify-content-md-center">
                    <Form.Group className="mb-3 justify-content-md-center" as={Col} md="6" >
                ...
                <Row className="justify-content-md-center">
                    <Form.Group className="mb-3 justify-content-md-center" as={Col} md="6" >
                        ...
                        <Form.Control type="password" placeholder="Confirm Password" name="password2" value={values.password2} onChange={handleChange} />
